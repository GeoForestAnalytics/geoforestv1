...
// Certifique-se de que este import contém a classe RendimentoDAP que criamos no passo anterior
...
class RendimentoDapPage extends StatefulWidget {
  ...
  // CORREÇÃO AQUI: Mudamos de RendimentoDapPage para RendimentoDAP (o modelo)
...
class _RendimentoDapPageState extends State<RendimentoDapPage> {
  ...
  Future<void> _exportarPdf() async {
    ...
    try {
      RenderRepaintBoundary boundary = _graficoKey.currentContext!
...
// ver isso depois
      ...
      await _pdfService.gerarRelatorioRendimentoPdf(
        context: context,
        titulo: '${widget.nomeFazenda} - ${widget.nomeTalhao}', // Ajuste no título
        dados: widget.dadosRendimento, // Nome do parâmetro ajustado conforme o service
      );
    } catch (e) {
      if (mounted) {
                ...
                child: SizedBox(
                  ...
                  child: BarChart(
                    BarChartData(
                          ...
                          getTooltipItem: (group, groupIndex, rod, rodIndex) {
                            ...
                            return BarTooltipItem(
                              ...
                              children: <TextSpan>[
                                TextSpan(
                                  text:
                                      '${item.volumePorHectare.toStringAsFixed(1)} m³/ha\n',
                        ...
                        bottomTitles: AxisTitles(
                          sideTitles: SideTitles(
                            ...
                            getTitlesWidget: (double value, TitleMeta meta) {
                              if (value.toInt() >=
                                  widget.dadosRendimento.length) {
                                return const SizedBox.shrink();
                              }
                              final classe =
                                  widget.dadosRendimento[value.toInt()].classe;
                              return Padding(
                      ...
                      barGroups:
                          widget.dadosRendimento.asMap().entries.map((entry) {
